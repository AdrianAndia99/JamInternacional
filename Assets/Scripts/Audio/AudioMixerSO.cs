...
[CreateAssetMenu(fileName = "AudioMixerSO", menuName = "Scriptable Audio/Audio/AudioMixerSO", order = 2)]
public class AudioMixerSO : ScriptableObject
{
    ...
    public void UpdateVolume(float value)
    {
        ...
        PlayerPrefs.Save();
        mainMixer.GetFloat(volumeKey, out value);
        Debug.Log($"Calling {this.name} - {value}");
    }
